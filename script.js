...
passInput.addEventListener('keyup', ()=>{
    let passCont = document.querySelector('.pass-cont');
    let passValue = passInput.value;
    let strength = Strength(passValue);
    if(strength<=2){
        passCont.classList.add('weak')
        passCont.classList.remove('medium')
        passCont.classList.remove('strong')
    }else if(strength>2 && strength<5){
        passCont.classList.add('medium')
        passCont.classList.remove('weak')
        passCont.classList.remove('strong')
    }else{
        passCont.classList.add('strong')
        passCont.classList.remove('medium')
        passCont.classList.remove('weak')
    }
})
function Strength(passValue){
    let i=0;
